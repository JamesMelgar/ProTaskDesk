...
import com.gyt.seguros.pro.task.desk.svc.project.ProjectType;
import com.gyt.seguros.pro.task.desk.svc.project.ProjectStatus;
import com.gyt.seguros.pro.task.desk.svc.project.CreateProjectSvc;
...
public class CreateProjectScreen extends JFrame {
    ...
    private void loadProjectTypes() {
        try {
            List<ProjectType> projectTypes = createProjectSvc.getProjectTypes();
